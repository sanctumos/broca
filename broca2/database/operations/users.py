...
async def get_or_create_letta_user(username: str = None, display_name: str = None, platform_user_id: str = None) -> LettaUser:
...
async def get_platform_profile_id(letta_user_id: int) -> Optional[Tuple[int, str]]:
