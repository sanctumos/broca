    ...
    def from_env(cls) -> 'WebChatSettings':
        ...
        try:
            return cls(
                ...
                plugin_name=os.getenv('WEB_CHAT_PLUGIN_NAME', 'q_vernal_webchat'),
                platform_name=os.getenv('WEB_CHAT_PLATFORM_NAME', 'q_vernal_webchat'),
            ...
            return cls(
                ...
                max_retries=3,
                retry_delay=10,
                plugin_name='q_vernal_webchat',
                platform_name='q_vernal_webchat',
