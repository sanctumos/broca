...
from plugins.q_vernal_webchat.settings import WebChatSettings
from plugins.q_vernal_webchat.api_client import WebChatAPIClient
...
class QVernalWebChatPlugin(Plugin):
    ...
    def register_event_handler(self, event_type, handler):
        """Register an event handler (unused for webchat poll plugin)."""
        pass

    def emit_event(self, event):
        """Emit an event (unused for webchat poll plugin)."""
        pass 