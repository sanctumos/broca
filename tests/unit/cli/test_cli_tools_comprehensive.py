...
class TestCLIToolsComprehensive:
    ...
    def test_qtool_main_flush_command(self):
        ...
        with patch('sys.argv', ['qtool', 'flush']):
    ...
    def test_qtool_main_delete_command(self):
        ...
        with patch('sys.argv', ['qtool', 'delete', '1']):
    ...
    def test_ctool_main_get_command(self):
        ...
        with patch('sys.argv', ['ctool', 'get', '1']):
    ...
    def test_settings_main_debug_command(self):
        ...
        with patch('sys.argv', ['settings', 'debug', 'true']):
    ...
    def test_btool_get_ignore_list_path_custom(self):
        ...
        with patch('cli.btool.os.getenv', return_value='/custom/path.json'):
            from cli.btool import get_ignore_list_path
            path = get_ignore_list_path()
    ...
    def test_qtool_print_json_with_data(self):
        ...
        with patch('cli.qtool.json.dumps', return_value='{"id": 1}'):
    ...
    def test_qtool_print_queue_items_with_data(self):
        ...
        mock_items = [
            {"id": 1, "content": "test1", "display_name": "Item 1"},
            {"id": 2, "content": "test2", "display_name": "Item 2"}
        ]
        with patch('builtins.print') as mock_print:
    ...
    def test_utool_print_json_with_data(self):
        ...
        with patch('cli.utool.json.dumps', return_value='{"id": 1}'):
            with patch('builtins.print') as mock_print:
    ...
    def test_utool_print_users_with_data(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            assert mock_print.call_count == 3  # Header + 2 users
    ...
    def test_ctool_print_json_with_data(self):
        ...
        with patch('cli.ctool.json.dumps', return_value='{"id": 1}'):
            with patch('builtins.print') as mock_print:
    ...
    def test_ctool_print_conversations_with_data(self):
        ...
        mock_conversations = [
            {"id": 1, "title": "conv1", "username": "user1", "display_name": "Conv 1"},
            {"id": 2, "title": "conv2", "username": "user2", "display_name": "Conv 2"}
        ]
        with patch('builtins.print') as mock_print:
    ...
    def test_settings_print_output_empty(self):
        ...
        with patch('builtins.print') as mock_print:
            from cli.settings import print_output
            print_output({})
            mock_print.assert_called_once_with("No settings found")
    ...
    def test_btool_add_bot_already_exists(self):
        ...
        with patch('cli.btool.load_ignore_list', return_value=["bot1", "bot2"]):
